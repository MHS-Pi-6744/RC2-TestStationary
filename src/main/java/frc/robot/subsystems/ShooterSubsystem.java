...
public class ShooterSubsystem extends SubsystemBase {
  ...
  private static double kShootPercent = frc.robot.Constants.ShooterSubsystemConstants.FlywheelSetpoints.kShootPercent;
     ...
     // private SparkMax feederMotor =
      ...
      private boolean isFlywheelAt(double velocity) {
        return MathUtil.isNear(flywheelEncoder.getVelocity(),   
                velocity, frc.robot.Constants.ShooterSubsystemConstants.FlywheelSetpoints.kVelocityTolerance);
      }
      ...
      public Command runFeederCommand() {
        return this.startEnd(
            () -> {
              this.setFlywheelVelocity(kShootPercent);
              this.setFeederPower(canIDs.kFeederMotorCanId);
            }, () -> {
              this.setFlywheelVelocity(0.0);
